...
''';
  ...
  static GeneratedFile _generatePubspec(
    ...
    final surface = tags.isEmpty ? info.title : '${info.title} surface ($tags)';
    final kind = pureSurface
        ? 'Pure-surface (transport-neutral, over an injected $corePackage RequestAdapter) Dart client'
        : 'Dart client';
    final description = info.description ??
        '$kind for the $surface, GENERATED by openapi_flutter_gen. '
            'Do NOT hand-edit lib/ — regenerate from the spec instead.';
    return GeneratedFile(
      path: 'pubspec.yaml',
      content: pureSurface
